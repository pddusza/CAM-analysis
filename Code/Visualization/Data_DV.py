...
filtered_tag_counts = tag_counts[tag_counts > 4]
...
#df_excluded.to_csv('/OLD-DATA-STOR/HESSO_Internship_2023/Piotr/Results/DataFrame_DV_Projection.csv', index=False)